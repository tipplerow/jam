...
public class TreeMapTable<K, V> extends AbstractMapTable<K, V> {
     ...
     */
    protected TreeMapTable(Function<V, K> keyFunc) {
        super(new TreeMap<K, V>(), keyFunc);
    }
     ...
     * @param keyFunc a function to generate keys for the records.
     */
    protected TreeMapTable(Iterable<V> records, Function<V, K> keyFunc) {
        super(JamMaps.tree(records, keyFunc), keyFunc);
    }
    ...
    public static <K, V> TreeMapTable<K, V> create(Function<V, K> keyFunc) {
        return new TreeMapTable<K, V>(keyFunc);
    }
     ...
     */
    public static <K, V> TreeMapTable<K, V> create(Iterable<V> records, Function<V, K> keyFunc) {
        return new TreeMapTable<K, V>(records, keyFunc);
    }
}
