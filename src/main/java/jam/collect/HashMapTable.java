...
public class HashMapTable<K, V> extends AbstractMapTable<K, V> {
     ...
     */
    protected HashMapTable(Function<V, K> keyFunc) {
        super(new HashMap<K, V>(), keyFunc);
    }
     ...
     * @param keyFunc a function to generate keys for the records.
     */
    protected HashMapTable(Iterable<V> records, Function<V, K> keyFunc) {
        super(JamMaps.hash(records, keyFunc), keyFunc);
    }
    ...
    public static <K, V> HashMapTable<K, V> create(Function<V, K> keyFunc) {
        return new HashMapTable<K, V>(keyFunc);
    }
     ...
     */
    public static <K, V> HashMapTable<K, V> create(Iterable<V> records, Function<V, K> keyFunc) {
        return new HashMapTable<K, V>(records, keyFunc);
    }
}
