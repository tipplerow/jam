...
public class RealDistributionTypeTest extends NumericTestBase {
    ...
    @Test public void testDiracDelta() {
        ...
        DiracDeltaDistribution dist2 = (DiracDeltaDistribution) RealDistributionType.DIRAC_DELTA.create("1.0");
    ...
    @Test public void testLogNormal() {
        ...
        LogNormalDistribution dist2 = (LogNormalDistribution) RealDistributionType.LOG_NORMAL.create("-1.0, 3.0");
    ...
    @Test public void testLogUniform() {
        ...
        LogUniformDistribution dist2 = (LogUniformDistribution) RealDistributionType.LOG_UNIFORM.create("-1.0, 3.0");
    ...
    @Test public void testNormal() {
        ...
        NormalDistribution dist2 = (NormalDistribution) RealDistributionType.NORMAL.create("-1.0, 3.0");
    ...
    @Test public void testUniform() {
        ...
        UniformRealDistribution dist2 = (UniformRealDistribution) RealDistributionType.UNIFORM.create("-1.0, 3.0");
