...
public class MissenseReaderTest {
    ...
    @Test public void testMC3() {
        ...
        assertRecord(reader.next(), "TCGA-02-0003-01A-01D-1490-08", "TACC2", "ENST00000369005", "T38M");

        assertTrue(reader.hasNext());
        assertRecord(reader.next(), "TCGA-02-0003-01A-01D-1490-08", "PANX3", "ENST00000284288", "R296Q");
    ...
    @Test public void testMiao() {
        ...
        assertRecord(records.get(0), "AC-DFCI_AC_PD1-1-Tumor-SM-9LRI9", "ASPM", "ENST00000367409", "S162F");
        assertRecord(records.get(8), "Y2087_T", "ALMS1", "ENST00000264448", "G3501E");
    }                     
