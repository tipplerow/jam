 ...
 * cohort).  The mapping from tumor barcode to cancer type is defined
 * by the global {@code CancerTypeDb} database.
 */
public final class CancerTypeProfile extends ExpressionProfile {
    private final CancerTypeDb cancerTypeDb = CancerTypeDb.global();
    ...
    @Override public Expression lookup(TumorBarcode barcode, HugoSymbol symbol) {
        CancerType cancerType = cancerTypeDb.require(barcode);
