...
public final class AntigenProcessor {
     ...
     */
    public static final String CLEAVAGE_LENGTH_PROPERTY = "jam.agpro.cleavageLength";

    /**
     * Name of the system property that specified whether to use the
     * {@code netchop} program to predict peptide cleavage products.
     */
    public static final String USE_NETCHOP_PROPERTY = "jam.agpro.useNetChop";
     ...
     */
    public static final String USE_TAP_PROPERTY = "jam.agpro.useTAP";
