...
public class QueryBuilderTest {
    @Test public void testBuilder() {
        ...
        builder.innerJoin("article_substances", "substance_key", "substances", "java_name");

        builder.innerJoin("articles", "pmid", "article_substances", "pmid");
    ...
    public static void main(String[] args) {
        org.junit.runner.JUnitCore.main("jam.sql.QueryBuilderTest");
    }
}
