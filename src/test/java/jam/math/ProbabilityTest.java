...
public class ProbabilityTest extends NumericTestBase {
    ...
    @Test public void testAccept() {
        ...
        for (int index = 0; index < numTrial; index++)
            if (prob.accept(random()))
                ++accepted;

        assertEquals(prob.doubleValue(), DoubleUtil.ratio(accepted, numTrial), 0.0003);
    }
    ...
    @Test public void testIfAllOccured() {
        ...
        for (int index = 0; index < 100; index++) {
            Probability single = Probability.valueOf(random().nextDouble());
    ...
    @Test public void testNot() {
        ...
        for (int index = 0; index < 100; index++) {
            Probability prob = Probability.valueOf(random().nextDouble());
    ...
    public static void main(String[] args) {
        org.junit.runner.JUnitCore.main("jam.math.ProbabilityTest");
    }
}
