...
public final class SelfPeptideDb {
     ...
     */
    public static final String CONFIG_FILE_PROPERTY = "jam.agpro.selfDbConfigFile";

    /**
     * Name of the system property that specifies the file containing
     * self-peptides mapped to HUGO symbol.
     */
    public static final String PEPTIDE_FILE_PROPERTY = "jam.agpro.selfDbPeptideFile";
