...
public abstract class ConcentrationModel {
     ...
     * concentration model.
     */
    public static final String CONC_MODEL_TYPE_PROPERTY = "jam.rna.concModelType";

    /**
     * System property that specified the minimum RNA expression
     * required for positive peptide concentration.
     */
    public static final String EXPR_THRESHOLD_PROPERTY = "jam.rna.exprThreshold";
     ...
     */
    public static final String MAX_EXPRESSION_PROPERTY = "jam.rna.maxExpression";
